 ...
 */
public class tastyRes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        final View view = inflater.inflate(R.layout.fragment_tasty_res, container, false);
        ...
        Call<List<Restaurant>> call = mostTastyRestaurants.getMostTasty();
        ...
        call.enqueue(new Callback<List<Restaurant>>() {
            ...
            public void onResponse(Call<List<Restaurant>> call, Response<List<Restaurant>> response) {
                ...
                rating.setText(Float.toString(restaurants.get(0).getRatingTasty()));
                ...
                rating1.setText(Float.toString(restaurants.get(1).getRatingTasty()));
                ...
                rating2.setText(Float.toString(restaurants.get(2).getRatingTasty()));
                ...
                rating3.setText(Float.toString(restaurants.get(3).getRatingTasty()));
                ...
                rating4.setText(Float.toString(restaurants.get(4).getRatingTasty()));
                ...
                rating5.setText(Float.toString(restaurants.get(5).getRatingTasty()));
