...
public class servicefrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<List<Restaurant>> call = bestServicesRes.getBetterServices();
        ...
        call.enqueue(new Callback<List<Restaurant>>() {
            ...
            public void onResponse(Call<List<Restaurant>> call, Response<List<Restaurant>> response) {
                ...
                rating1.setText(Float.toString(restaurants.get(1).getRatingS()));
                ...
                rating2.setText(Float.toString(restaurants.get(2).getRatingS()));
                ...
                rating3.setText(Float.toString(restaurants.get(3).getRatingS()));
                ...
                rating4.setText(Float.toString(restaurants.get(4).getRatingS()));
                ...
                rating5.setText(Float.toString(restaurants.get(5).getRatingS()));
